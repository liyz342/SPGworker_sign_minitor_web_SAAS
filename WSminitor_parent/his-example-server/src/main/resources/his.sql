...
CREATE TABLE `ban`  (
  ...
  `bname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `baoque`  (
  ...
  `baoqueName` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `bed`  (
  ...
  `bedname` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `caigou`  (
  ...
  `caigouname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `gonghuoshang` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `danwei` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `candi` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `leixing` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `cashier`  (
  ...
  `durgname` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  `jie` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `departments`  (
  ...
  `department` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `doctor`  (
  ...
  `doctorName` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `departmentId` int NOT NULL,
  `registeredId` int NOT NULL,
  `dstate` int NULL DEFAULT NULL,
  `amStartTime` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '8:00',
  `amEndTime` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '12:00',
  `pmStartTime` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '14:00',
  `pmEndTime` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '18:00',
...
CREATE TABLE `drugdictionary`  (
  ...
  `drugName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `unitId` int NOT NULL,
...
CREATE TABLE `drugstore`  (
  ...
  `drugstoreName` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  `batch` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `home`  (
  ...
  `homeName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sex` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `age` int NULL DEFAULT NULL,
  `carId` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`homeId`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 75 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hospitalmeta`  (
  `hospitalId` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `hospitalName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '医院名',
  `hospitalAddress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '医院地址',
  `mysqlUrl` varchar(127) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'mysql地址',
  `mysqlSchema` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'mysql库名',
  `mysqlUsername` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'mysql用户名',
  `mysqlPassword` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'mysql密码',
  `mysqlStatus` int NULL DEFAULT NULL COMMENT '0-未建库;1-已建库',
  PRIMARY KEY (`hospitalId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1959870467 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hospitalmeta
-- ----------------------------
INSERT INTO `hospitalmeta` VALUES (2, '人民医院', ',xx街道xx号,xx街道xx号', 'localhost:3306', 'renminghis', 'root', 'root', 1);
INSERT INTO `hospitalmeta` VALUES (1959870466, '暨南大学第一附属医院', ',广东省广州市黄埔大道西613号', 'localhost:3306', 'jnu_1st_his', 'root', 'Jnu_2023', 1);
...
) ENGINE = MyISAM AUTO_INCREMENT = 109 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `huishou`  (
  ...
  `huishouname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `huishounumber` int NOT NULL,
  `huishoupihao` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `jbr` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `beizhu` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `inhospitaltype`  (
  ...
  `projectName` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `unit` int NOT NULL,
...
CREATE TABLE `jilu`  (
  ...
  `jiluname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `jilutime` datetime NOT NULL,
  `jilutype` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `jilupeople` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `jilunumber` int NULL DEFAULT NULL,
  `jilupihao` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`jiluid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 242 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `moneytype`  (
  ...
  `Moneytype` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `Percent` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `paiban`  (
  ...
  `one` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `two` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `three` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `four` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `five` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `six` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
  `seven` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '无班',
...
CREATE TABLE `pharmacy`  (
  ...
  `pharmacyName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  `validDate` date NOT NULL,
  `drugstorenum` int NOT NULL,
  `skullbatch` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `register`  (
  ...
  `doctor` int NOT NULL,
  `diagnose` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `Idcard` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `registerDate` datetime NULL DEFAULT NULL,
  `bedNum` int NULL DEFAULT NULL,
  `Operator` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `money` double NULL DEFAULT NULL,
  `state` int NULL DEFAULT NULL,
  `endDate` datetime NULL DEFAULT NULL,
  `price` double UNSIGNED NULL DEFAULT NULL,
  `discount` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `registeredtype`  (
  ...
  `type` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `price` double NOT NULL,
...
CREATE TABLE `report`  (
  ...
  `reportName` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sex` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `age` int NULL DEFAULT NULL,
  ...
  `users` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `state` int NULL DEFAULT NULL,
  `phone` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `carid` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `zhuan` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `skull`  (
  ...
  `skullName` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `sys_menu` VALUES (2, 1, '体征监测管理', '', 0, NULL, '&#xe653;', 1);
INSERT INTO `sys_menu` VALUES (3, 1, '异常告警管理', '', 0, NULL, '&#xe663;', 1);
INSERT INTO `sys_menu` VALUES (4, 1, '系统管理', '', 0, '', '&#xe716;', 1);
INSERT INTO `sys_menu` VALUES (5, 1, '统计管理', '', 0, NULL, '&#xe629;', 1);
INSERT INTO `sys_menu` VALUES (6, 2, '工人信息', '../outpaient/index', 0, NULL, '&#xe770;', 1);
INSERT INTO `sys_menu` VALUES (7, 2, '设备信息', '../outpaientcc/cc', 0, NULL, '&#xe657;', 1);
INSERT INTO `sys_menu` VALUES (8, 3, '告警记录', '../inpaient/admin', 0, NULL, '&#xe65b;', 1);
INSERT INTO `sys_menu` VALUES (9, 3, '告警报告查看', '../inpaient/pay', 0, NULL, '&#xe6b2;', 1);
INSERT INTO `sys_menu` VALUES (11, 3, '告警记账', '../inpaient/drug', 0, NULL, '&#xe705;', 1);
...
INSERT INTO `sys_menu` VALUES (18, 5, '监测月度统计', '../toReportFinance', 0, NULL, '&#xe63c;', 1);
INSERT INTO `sys_menu` VALUES (19, 5, '异常月度统计', '../toZhuYaunManage', 0, NULL, '&#xe62c;', 1);
INSERT INTO `sys_menu` VALUES (20, 5, '监测年度统计', '../toBingYear', 0, NULL, '&#xe62d;', 1);
INSERT INTO `sys_menu` VALUES (27, 2, '告警信息', '../outpaientout/xiang', 0, NULL, '&#xe60a;', 1);
INSERT INTO `sys_menu` VALUES (28, 2, '项目缴费', '../xpay/xiangpay', 0, NULL, '&#xe65e;', 1);
INSERT INTO `sys_menu` VALUES (30, 1, '数据中心', '', 0, NULL, '&#xe60a;', 1);
INSERT INTO `sys_menu` VALUES (31, 30, '机构中心', '../toDepartments', 0, NULL, '&#xe68e;', 1);
INSERT INTO `sys_menu` VALUES (32, 30, '工人列表', '../toDoctor', 0, NULL, '&#xe66f;', 1);
INSERT INTO `sys_menu` VALUES (33, 30, '设备产地', '../toArea', 0, NULL, '&#xe630;', 1);
INSERT INTO `sys_menu` VALUES (36, 30, '项目大类', '../toProjectTypeManage', 0, NULL, '&#xe620;', 1);
INSERT INTO `sys_menu` VALUES (37, 30, '体征监控类型', '../toRegisteredType', 0, NULL, '&#xe672;', 1);
...
INSERT INTO `sys_menu` VALUES (44, 30, '设备分类', '../toType', 0, NULL, '&#xe656;', 1);
INSERT INTO `sys_menu` VALUES (46, 1, '排班管理', '1', 0, NULL, '&#xe770;', 1);
INSERT INTO `sys_menu` VALUES (47, 46, '工人排班', '../toPaiban', 0, NULL, '&#xe770;', 1);
INSERT INTO `sys_menu` VALUES (48, 30, '设备产地', '../toDrugdictionary', 0, NULL, '&#xe64d;', 1);
INSERT INTO `sys_menu` VALUES (49, 3, '项目记账', '../inpaient/item', 0, NULL, '&#xe705;', 1);
INSERT INTO `sys_menu` VALUES (52, 5, '异常年度统计', '../toBing2', 0, NULL, '&#xe630;', 1);
INSERT INTO `sys_menu` VALUES (53, 2, '体征评估信息', '../xpay/seljian', 0, NULL, '&#xe674;', 1);
INSERT INTO `sys_menu` VALUES (54, 1, '仓库管理', '', 0, NULL, '&#xe61c;', 1);
INSERT INTO `sys_menu` VALUES (55, 54, '入库单', '../dsnavigation/beputinstorage', 0, NULL, '&#xe657;', 1);
INSERT INTO `sys_menu` VALUES (56, 5, '工人统计对比', '../toDoctorDuibi', 0, NULL, '&#xe770;', 1);
...
INSERT INTO `sys_menu` VALUES (60, 54, '有效期提醒', '../dsnavigation/seldrugDate', 0, NULL, '&#xe702;', 1);
INSERT INTO `sys_menu` VALUES (61, 1, '设备管理', '', 0, NULL, '&#xe705;', 1);
INSERT INTO `sys_menu` VALUES (62, 61, '部门详情', '../dsnavigation/pharymacyhtml', 0, NULL, '&#xe632;', 1);
INSERT INTO `sys_menu` VALUES (64, 2, '评估报告', '../outpaientout/out', 0, NULL, '&#xe65e;', 1);
INSERT INTO `sys_menu` VALUES (65, 5, '监测当天统计', '../toCurrent', 0, NULL, '&#xe60e;', 1);
INSERT INTO `sys_menu` VALUES (69, 2, '评估模型管理', '../outpaienttake/haun', 0, NULL, '&#xe66f;', 1);
INSERT INTO `sys_menu` VALUES (70, 54, '操作记录', '../dsnavigation/record', 0, NULL, '&#xe6b2;', 1);
INSERT INTO `sys_menu` VALUES (71, 54, '设备回收', '../dsnavigation/recycle', 0, NULL, '&#xe669;', 1);
INSERT INTO `sys_menu` VALUES (72, 61, '正常体征设备', '../outpaienttake/seltake', 0, NULL, '&#xe857;', 1);
INSERT INTO `sys_menu` VALUES (73, 61, '异常体征设备', '../inpaient/pharmacy', 0, NULL, '&#xe63c;', 1);
INSERT INTO `sys_menu` VALUES (86, 3, '告警结算', '../inpaient/leave', 0, NULL, '&#xe65a;', 1);
INSERT INTO `sys_menu` VALUES (90, 2, 'test', '', 0, NULL, '&#xe678;', 1);
INSERT INTO `sys_menu` VALUES (92, 4, '机构基础信息维护', '../toHospitalManage', 0, NULL, '&#xe7ae;', 1);
...
CREATE TABLE `unit`  (
  ...
  `unitName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `upplier`  (
  ...
  `supplierName` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `supplierPhone` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `supplierAddress` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `state` int NULL DEFAULT NULL,
